...
define('COREFRAME_ROOT','D:\WWW\mycms\coreframe/');//定义核心框架的路径
define('CACHE_ROOT','D:\WWW\mycms\caches/');//缓存文件目录
...
define('WWW_PATH','/mycms/www/');//网站安装路径，二级目录形式为：/mydemo/
define('WEBURL','http://192.168.1.119/mycms/www/');//网站域名
...
define('ATTACHMENT_URL','http://192.168.1.119/mycms/www/uploadfile/');//附件路径
define('R','http://192.168.1.119/mycms/www/res/');//静态文件存储目录

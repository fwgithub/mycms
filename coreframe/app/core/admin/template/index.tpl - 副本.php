            ...
            foreach($panels as $menuid=>$panel) {
               // if($menuid!=1) continue;
                ...
                <ul class="sidebar-menu <?php if($menuid!='1') echo 'hide';?>" id="panel-<?php echo $menuid;?>">
                    ...
                    <li><a href="#" ><i></i>运营数据统计</a>
                        <ul >
                            <li><a href="#">> 客户端安装卸载统计</a></li>
                            <li ><a href="#">> 运营数据统计 </a></li>
                            <li><a href="#">> 用户留存率 </a></li>
                            <li ><a href="#">> 充值超过某值用户</a></li>
                            <li><a href="#">> 流失账号主线统计</a></li>
                            <li><a href="#">> 分服留存率统计 </a></li>
                        </ul>
                    </li>

                    <li><a href="#" ><i></i>广告监控 </a>
                        <ul>
                            <li><a href="#">> 媒体列表</a></li>
                            <li><a href="#">> 投放广告列表 </a></li>
                            <li><a href="#">> 百度投放 </a></li>
                        </ul>
                    </li>
                    <li><a href="#" ><i></i>财务查询 </a>
                        <ul>
                            <li><a href="#">> 每日支付查询</a></li>
                            <li><a href="#">> 每日充值统计 </a></li>
                        </ul>
                    </li>
                    <li><a href="#" ><i></i>游戏数据统计 </a>
                        <ul>
                            <li><a href="#">> 实时在线统计</a></li>
                            <li><a href="#">> 历史在线统计 </a></li>
                            <li><a href="#">> 日新增用户数</a></li>
                            <li><a href="#">> KPI总报表 </a></li>
                            <li><a href="#">> KPI分服报表</a></li>
                            <li><a href="#">> 游戏币统计 </a></li>
                            <li><a href="#">> （各种）活动统计</a></li>
                            <li><a href="#">> 角色统计 </a></li>
                            <li><a href="#">> 随身商店售出物品统计</a></li>
                            <li><a href="#">> 历史登录账号数 </a></li>
                            <li><a href="#">> 大闹天宫活动统计</a></li>
                            <li><a href="#">> 战斗力排行 </a></li>
                            <li><a href="#">> 武圣各服角色提取统计</a></li>
                        </ul>
                    </li>
                    <li><a href="#"><i></i>GM工具 </a>
                        <ul>
                            <li><a href="#">> 查看重置账号操作</a></li>
                            <li><a href="#">> 重置账号密码密保 </a></li>
                            <li><a href="#">> 查询账号信息</a></li>
                            <li><a href="#">> 账号操作处理</a></li>
                            <li><a href="#">> 用户角色查询</a></li>
                            <li><a href="#">> 用户角色操作 </a></li>
                            <li><a href="#">> 公告管理</a></li>
                            <li><a href="#">> 公告发送 </a></li>
                            <li><a href="#">> GM权限管理</a></li>
                            <li><a href="#">> 地图服务器设置 </a></li>
                            <li><a href="#">> 地图服务器查询</a></li>
                            <li><a href="#">> 添加怪物 </a></li>
                            <li><a href="#">> 机器人排队设置</a></li>
